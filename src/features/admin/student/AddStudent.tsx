...
import { codeValidation, genderValidation, joiningYearValidation, nameValidation, passwordValidation } from "@/constants/validations";
      ...
      >
        ...
        >
          ...
          <InputField
            ...
            inputProps={register("grandfatherName", {...nameValidation,deps:["grandfatherName"]})}
            error={Boolean(errors.grandfatherName)}
            helperText={
              Boolean(errors.grandfatherName) === true ? "Required" : " "
            }
            variant={"outlined"}
          />
        </Stack>
        ...
        >
          <InputField
            label="Joining Year"
            inputProps={register("joining_year", {...joiningYearValidation,deps:["joining_year"]})}
            error={Boolean(errors.joining_year)}
            helperText={
              Boolean(errors.joining_year) === true ? "Required" : " "
            }
            variant={"outlined"}
          />
        </Stack>
        ...
        >
          ...
          <SelectField
            ...
            helperText={
              Boolean(errors.department_code) === true ? "Required" : " "
            }
